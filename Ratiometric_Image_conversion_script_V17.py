...
#@ String(value="<html style=\"width: 400px;text-align: center;\">Please cite Barbez et al. 2017<br/>and Rößling et al. 2026</html>", visibility=MESSAGE, required=false) footer
